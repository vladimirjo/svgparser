...
from dtd.dtdentity import GeneralEntity, ParameterEntity
...
def test__resolve_pent():
    ...
    pent_abc = ParameterEntity(1,None, None, xmlchars_abc)
    pent_def = ParameterEntity(2,None, None, xmlchars_def)
    pent_ghi = ParameterEntity(3,None, None, xmlchars_ghi)
    gent_jkl = GeneralEntity(3,None, None, None, xmlchars_jkl)
